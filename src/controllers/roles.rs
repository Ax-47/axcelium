use crate::{
    application::controllers::role_handle::{
        assign_handler, create_role_handler, delete_role_handler, get_role_by_app_handler, get_roles_by_app_handler, get_users_by_role_handler, update_role_handler
    },
    setup::Container,
};
...
pub fn configure(cfg: &mut ServiceConfig, container: Arc<Container>) {
    ...
    cfg.service(
        web::scope("/roles")
            ...
            .app_data(web::Data::from(container.assign_service.clone()))
            .wrap(middleware)
            ...
            .route("/{role_id}/assign", web::post().to(assign_handler))
