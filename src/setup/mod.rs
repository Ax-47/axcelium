use crate::{
    application::{
        ...
        services::{
            ...
            roles::{create_roles::CreateRoleService, get::GetRoleService},
            users::{
...
pub struct Container {
    ...
    pub get_role_by_role_id_service: Arc<dyn GetRoleService>,
}
...
impl Container {
    pub async fn new(cfg: config::Config, cache: Arc<Client>, database: Arc<Session>) -> Self {
        ...
        let get_role_by_role_id_service = services::create_get_role_by_role_id_service(&repos);
